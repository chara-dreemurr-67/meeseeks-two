...
export default (): (Handler: (Interaction: ButtonInteraction, Type: ButtonType, Client: Client) => Promise<void>) => Record<ButtonType, (Interaction: ButtonInteraction, Client: Client) => Promise<void>> => 
(Handler: (Interaction: ButtonInteraction, Type: ButtonType, Client: Client) => Promise<void>): Record<ButtonType, (Interaction: ButtonInteraction, Client: Client) => Promise<void>> => ({
